    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <form id="my-form" action="{{route('ledger_wages.store')}}" method="POST">
                        @csrf
                        <div class="row">
                                    ...
                                    <div id="child" class="col-4">
                                        <div class="row card">
                                            <div class="col-12 my-2">
                                                <x-label>wage</x-label>
                                                <x-datalist name="wage[]" :data="$wages" column="wd_desc" class="input-wg"></x-datalist>
                                                <x-validation name="wage[]"></x-validation>
                                            </div>
                            ...
                            <div class="col-12 my-2">
                                <button class="btn btn-info btn-sm" type="button" id="add-input-btn">Add wage</button>
                                <button class="btn btn-danger btn-sm" type="button" id="minus-btn">Remove wage</button>

                                <x-btn>Save Wage</x-btn>
